...
/// <summary>
/// Provides JSON serialization and deserialization extensions for <see cref="EncodingUtilityBenchmarks"/>
/// to enable benchmark results persistence and exchange.
/// </summary>
public static class EncodingUtilityBenchmarksJsonExtensions
{
    /// <summary>
    ...
    /// <summary>
    /// Serializes the <see cref="EncodingUtilityBenchmarks"/> instance to a JSON string.
    /// </summary>
    ...
    public static string ToJson(this EncodingUtilityBenchmarks value, bool indented = false)
    {
    ...
    public static EncodingUtilityBenchmarks? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<EncodingUtilityBenchmarks>(json, _jsonOptions);
    }

    /// <summary>
    /// Attempts to deserialize a JSON string into a <see cref="EncodingUtilityBenchmarks"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    ...
    public static bool TryFromJson(string json, out EncodingUtilityBenchmarks? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<EncodingUtilityBenchmarks>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
