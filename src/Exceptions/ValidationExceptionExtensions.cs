...
public static class ValidationExceptionExtensions
{
    ...
    public static bool HasErrors(this ValidationException exception) =>
        exception == null ? throw new ArgumentNullException(nameof(exception)) : exception.Errors.Count > 0;
    ...
    public static IReadOnlyCollection<string> GetErrorMessages(this ValidationException exception) =>
        exception == null ? throw new ArgumentNullException(nameof(exception)) : exception.Errors.Values.ToList().AsReadOnly();
    ...
    public static string ToErrorSummary(this ValidationException exception) =>
        exception == null ? throw new ArgumentNullException(nameof(exception)) :
        exception.Errors.Count == 0 ? string.Empty :
